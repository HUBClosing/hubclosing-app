...
.hero>*:not(.hero-network):not(.hero-particles){position:relative;z-index:2;}
...
[output truncated at 50000 of 71098 characters. Pass a larger max_chars (default 50000) to see more, or use read_page with a ref_id to focus on a smaller section.]