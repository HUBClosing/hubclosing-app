    ...
    try {
      ...
      if (!res.ok) {
        if (data.code === 'PREMIUM_REQUIRED') {
          ...
          // Vérifier si questionnaire à remplir
      ...
      // Si questionnaire, passer à l'étape suivante
  ...
  if (!offer) {
    return (
      <div className="max-w-2xl mx-auto py-12 text-center">
        ...
        <a href="/dashboard/marketplace" className="text-sm text-brand-green hover:underline mt-2 block">
  ...
  if (step === 'apply') {
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          <a
            href={`/dashboard/marketplace/${offerId}`}
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="flex items-center gap-3 mt-2 text-xs text-gray-400">
              ...
              {offer.commission_rate && <span>Commission : {offer.commission_rate}%</span>}
            </div>
          </CardContent>
        </Card>
