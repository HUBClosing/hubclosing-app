...
const CANDIDATE_TIERS: TierInfo[] = [
  {
    ...
    features: [
      ...
      { label: 'Replay masterclass mensuelle', included: false },
  ...
  },
  {
    ...
    loseIfDowngrade: [
      ...
      'CV de performance partageable',
      'Score de réputation public',
    ],
  },
  {
    tier: 'pro',
    ...
    features: [
      ...
      { label: 'Masterclasses', included: true },
      { label: 'Replay masterclass mensuelle', included: true },
      { label: 'Montée en compétence mensuelle', included: false },
      { label: 'Outils de comptabilité', included: false },
      { label: 'Contact direct recruteurs', included: false },
    ],
    loseIfDowngrade: [
      ...
      'Masterclasses et replays',
    ],
  },
  {
    tier: 'elite',
    name: 'Élite',
    subtitle: 'Réseau + montée en compétence',
